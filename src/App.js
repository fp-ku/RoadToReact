    ...
    return (
      <div className="page">
        ...
        { error
          ...
          : <List list={list} onDismiss={this.onDismiss} sortKey={sortKey} onSort={this.onSort} isSortReverse={isSortReverse}/>
      }
        <div className="interactions">
...
const List = ({ list, onDismiss, sortKey, onSort, isSortReverse }) => {
